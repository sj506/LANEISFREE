                    ...
                    <div class="pro_review col-6">
                        ...
                        <div class="review ">
                            ...
                            <div>
                                ...
                                <ul>
                                    <li class="info_ctnt">상품과 관련이 없거나, 이미 등록된 사진, 타인의 리뷰에서 도용한 사진, 화면 캡쳐등의 리뷰는 라네즈프리 공식몰
                                        리뷰 정책에 따라 게시가 제한될 수 있습니다.</li>
                                    <li class="info_ctnt">상품과 관련 없는 내용이나 사진/동여상, 동일 문자 반복, 욕설이나 타인의 리뷰 도용 등의 내용이 포함 된 경우
                                        통보없이 삭제 및 뷰티포인트 적립 혜택이 회수될 수 있습니다.</li>
                                    <li class="info_ctnt">한 주문 건 내 동일 제품을 여러 개 구매하시는 경우 1회만 리뷰 작성이 가능하며, 리뷰포인트 적립도 1회만
                                        가능합니다.</li>
                            ...
                            <div>
                                ...
                                <ul>
                                    <li class="info_ctnt">2022년 1월 1일부터 뷰티포인트 운영 정책에 따라 비구매성 포인트(이벤트포인트)는 연간 누적
                                        2,000,000P를 초과하거나 동일한 적립 사유로 고객님의 일 적립 요청횟수가 50회를 초과하는 경우, 뷰티포인트 적립이 불가능합니다.
                                    </li>
                                    <li class="info_P">※ 비구매성 포인트 예시: 리뷰 작성, 리뷰 프로필 등록, 이벤트 참여, 공병수거 적립, 공병 프리퀀시 혜택, 특정
                                        제품 구매 추가 적립 등으로 인한 적립 뷰티포인트 </li>
                        ...
                        <div class="review--content">
                            <form @submit.prevent="submitForm">
                                ...
                                <div class="stars-widget" @click="starBtn">
                                    <label><i class="fa-solid fa-star"></i><input type="radio" class="star-radio"
                                            id="star_1" name="star" value="1" v-model="review_ctnt.star" /></label>
                                    <label><i class="fa-solid fa-star"></i><input type="radio" class="star-radio"
                                            id="star_2" name="star" value="2" v-model="review_ctnt.star" /></label>
                                    <label><i class="fa-solid fa-star"></i><input type="radio" class="star-radio"
                                            id="star_3" name="star" value="3" v-model="review_ctnt.star" /></label>
                                    <label><i class="fa-solid fa-star"></i><input type="radio" class="star-radio"
                                            id="star_4" name="star" value="4" v-model="review_ctnt.star" /></label>
                                    <label><i class="fa-solid fa-star"></i><input type="radio" class="star-radio"
                                            id="star_5" name="star" value="5" v-model="review_ctnt.star" /></label>
                                </div>
